	...
	render(){
		return(
			...
			<div
				...
				>
			<h1 className='titleMain'>Create Character</h1>
			<label >Character Name </label>
			<input className='creationForm' type = 'text' value={this.state.playerName} onChange = {this.handleChangeName} /><br/>
			<label data-tooltip="Choose your race">Race  </label><input list='races' className='creationForm' name='availableRaces' onChange={this.chooseRace}/>
				<datalist id="races">
    				<option key='race1' value="Human">Human</option>
    				<option key='race2'value="Undead">Undead</option>
    				<option key='race3'value="Elf">Elf</option>
    				<option key='race4'value="Orc">Orc</option>
  				</datalist> <br/>

			<label>Gender</label><input className='creationForm' list='genders' name='availableGenders' onChange = {this.changeGender} />
				<datalist id='genders'>
